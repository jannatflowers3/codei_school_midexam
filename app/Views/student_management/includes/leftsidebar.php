...
<aside class="main-sidebar sidebar-dark-primary elevation-4 sidcolor">
    ...
    <a href="index3.html" class="brand-link">
      <img src="/admin_dashboard/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Student Management System</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="/admin_dashboard/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">Jannat</a>
        </div>
      </div>
<nav class="mt-2">
